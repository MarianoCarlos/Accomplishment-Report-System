            ...
            <div className="w-full bg-[#003468] dark:bg-blue-950 border-b border-blue-900 dark:border-blue-800">
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="ml-4 flex flex-col">
                        <h1 className="text-base font-semibold text-white dark:text-gray-50">
                            Commission on Higher Education Regional Office XII (CHEDRO XII)
                        </h1>
                        <p className="text-sm font-medium text-white dark:text-gray-50">
